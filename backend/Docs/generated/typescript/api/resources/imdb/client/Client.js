...
const ArthurbrennoApi = __importStar(require("../../.."));
    ...
    createMovie(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                throw new errors.ArthurbrennoApiError({
            ...
            switch (_response.error.reason) {
                ...
                case "timeout":
                    throw new errors.ArthurbrennoApiTimeoutError();
                case "unknown":
                    throw new errors.ArthurbrennoApiError({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (_response.error.reason === "status-code") {
                switch (_response.error.statusCode) {
                    case 404:
                        throw new ArthurbrennoApi.MovieDoesNotExistError(yield serializers.MovieId.parseOrThrow(_response.error.body, {
                            unrecognizedObjectKeys: "passthrough",
                            allowUnrecognizedUnionMembers: true,
                            allowUnrecognizedEnumValues: true,
                            breadcrumbsPrefix: ["response"],
